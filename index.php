...
<head>
    ...
    <!-- Fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Itim&family=Julius+Sans+One&family=Karla:wght@100;300;400&family=Nothing+You+Could+Do&family=Overlock:ital@0;1&family=Roboto+Mono:wght@100;200;300;400;500;600;700&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Itim&family=Julius+Sans+One&family=Karla:wght@200;300;400&family=Lato:wght@300&family=Nothing+You+Could+Do&family=Overlock:ital@0;1&family=Roboto+Mono:wght@100;200;300;400;500;600;700&family=Roboto:wght@100;200;300;400;500;600;700&display=swap" rel="stylesheet">
    <!--2.animate.css (MIT) -->
    <link href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.0.0/animate.compat.css" rel="stylesheet" />


    <!-- Own stylesheets -->
    <link href="CSS/<?php echo ($version) ?>/main.css" rel="stylesheet">
    <link href="CSS/<?php echo ($version) ?>/menu.css" rel="stylesheet">
    ...
    <link href="CSS/<?php echo ($version) ?>/sections/sections.css" rel="stylesheet">
    ...
    <link href="CSS/<?php echo ($version) ?>/sections/welcome.css" rel="stylesheet">
    ...
    <link href="CSS/<?php echo ($version) ?>/projects/projectCard.css" rel="stylesheet">
    ...
    <meta name="keywords" content="web design, portfolio, web development, web development, HTML, CSS, Javascript, Design" />
    <meta charset="UTF-8">
    <!-- Motion library -->
