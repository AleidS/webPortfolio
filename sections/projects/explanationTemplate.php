     ...
     <div class="explanation">
         ...
         <?php if (isset($imgName)) : ?>
             <div class="imgAndCaption">
                 <img class="exImg" loading="lazy" src=<?php echo 'Images/projects/' . $imgName ?> />
                 <!-- Image caption -->
             ...
             <?php if (isset($logo)) : ?>
                 <div class="explanationLogosContainer mobile">
                     <div class="explanationLogoContainer">
                         <img loading="lazy" src=<?php echo ("Images/logos/" . $logo) ?> alt=<?php echo ($logo . "logo") ?> class="explanationLogo lazy" />
                     </div>
                     ...
                     <?php if (isset($logo2)) : ?>
                         ...
                         <div class="explanationLogoContainer logo2">
                             <img loading="lazy" src=<?php echo ("Images/logos/" . $logo2) ?> alt=<?php echo ($logo2 . "logo") ?> class="explanationLogo lazy" />
                         </div>
                     <?php endif ?>
                 </div>
             <?php endif ?>
